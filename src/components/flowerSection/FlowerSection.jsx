      ...
      <Wrapper>
        <div className="flower__text">
          ...
          <p className="p-2">
            ...
            dolores a deleniti laborum adipisci culpa maiores obcaecati pariatur
            molestiae minima accusamus, ipsum nobis vero atque magni facere
            maxime, accusantium inventore.
          </p>
        </div>
        <Carousel
